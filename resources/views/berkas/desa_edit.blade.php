    ...
    <div class="card-body">
        <form action="{{ route('desa.update', $desa->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="kecamatan_id" class="form-control @error('kecamatan_id') is-invalid @enderror" required>
                    ...
                    @foreach($kecamatans as $kec)
                        <option value="{{ $kec->id }}" {{ old('kecamatan_id', $desa->kecamatan_id) == $kec->id ? 'selected' : '' }}>{{ $kec->nama }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $desa->nama) }}" required>
